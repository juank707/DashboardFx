...
//import io.github.gleidson28.global.plugin.I18n;
 ...
 */
public class DataTableHandler<E extends Model> {
    ...
    public DataTableHandler(TableView<E> table, Hyperlink first, Hyperlink last,
...
//        updatePagination(converter.size());
                ...
                c -> {
                    if(c.getUserData() != null) {
                        if (c.getUserData().equals("check-column")) {
                            this.table.getColumns().remove(c);
                        }
                    }
                }
        );
    ...
    public void addCheckBoxColumn() {
        ...
        this.table.getColumns().add(0, columnSelected);
        columnSelected.setMaxWidth(1800);
